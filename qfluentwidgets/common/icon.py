...
class FluentIcon(FluentIconBase, Enum):
    ...
    def path(self, theme=Theme.AUTO):
        #path = f':/qfluentwidgets/images/icons/{self.value}_{getIconColor(theme)}.svg'
        from pathlib import Path
        path = Path(__file__).parent.parent.parent / f'qfluentwidgets/_rc/images/icons/{self.value}_{getIconColor(theme)}.svg'
